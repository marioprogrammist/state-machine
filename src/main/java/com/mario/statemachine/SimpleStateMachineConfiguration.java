...
public class SimpleStateMachineConfiguration  extends StateMachineConfigurerAdapter<String, String> {
    ...
    public Action<String, String> entryAction() {
        return ctx -> LOGGER.info("ACCION DE ENTRADA AL ESTADO S3 " + ctx
                .getTarget()
                .getId());
    }
    ...
    public Action<String, String> executeAction() {
        return ctx -> {
            LOGGER.info("EJECUCION DE ESTADOS S4 Y S5 " + ctx
                    .getTarget()
                    .getId());
    ...
    public Action<String, String> exitAction() {
        return ctx -> LOGGER.info("ACCION DE SALIDA AL ESTADO S3 " + ctx
                .getSource()
                .getId() + " -> " + ctx
                .getTarget()
                .getId());
    ...
    public Action<String, String> initAction() {
        return ctx -> LOGGER.info("INIT ACTION :: ACCION DE LA PRIMERA TRANSICION :: getTarget().getId() :: "+ ctx
                .getTarget()
                .getId());
    }
}
